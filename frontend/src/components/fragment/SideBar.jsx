    ...
    return (
        <aside style={useStyle.component} className={"aside-bar"}>
            <div className="aside-bar-container">
                ...
                {/* <SideBarOptions className={"lib-sub"} Icon={FeedbackOutlined} href={"/home/feedback"}  title={"Feedback"}/> */}
            ...
            <div className="aside-bar-container playlist">
                ...
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/chillbeats"}  title={"Chill Beats"}/>
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/yoga"}  title={"Yoga & Meditation"}/>
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/indian"}  title={"Indian Instrumental"}/>
            </div>
        </aside>
    );
}
